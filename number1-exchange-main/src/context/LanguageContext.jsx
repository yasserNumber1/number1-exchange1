...
const translations = {
  ar: {
    ...
    hero_badge:'LIVE · منصة موثوقة ومرخصة', hero_title:'تبادل العملات الرقمية', hero_desc:'منصة Number 1 تقدم أفضل أسعار الصرف وأسرع معالجة للمعاملات مع حماية متكاملة لأموالك.', hero_btn:'تعرف علينا', hero_users:'مستخدم نشط', hero_tx:'معاملة ناجحة', hero_pairs:'زوج تبادل مدعوم',
