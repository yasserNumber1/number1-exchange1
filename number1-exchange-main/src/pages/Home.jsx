...
function FeaturesSection() {
  ...
  const FEATURES=[
    ...
    {icon:<svg width="26" height="26" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="fl" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#00d2ff"/><stop offset="100%" stopColor="#0066aa"/></linearGradient></defs><rect x="3" y="11" width="18" height="11" rx="2.5" fill="url(#fl)" opacity="0.85"/><path d="M7 11V7a5 5 0 0110 0v4" fill="none" stroke="var(--cyan)" strokeWidth="2.2" strokeLinecap="round"/></svg>,titleAr:"أمان عالي المستوى",titleEn:"High-Level Security",descAr:"تشفير AES-256 وحماية متعددة الطبقات لضمان سلامة أموالك وبياناتك",descEn:"AES-256 encryption and multi-layer protection for your funds"},
