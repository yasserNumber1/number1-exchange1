...
export const NEWS = [
  ...
  { icon:'🌍', tagAr:'توسع',   tagEn:'EXPANSION', titleAr:'توسع خدمات Number 1 لتشمل دول الخليج العربي',         titleEn:'Number 1 Services Expand to Include Gulf Countries',           date:'10 Mar 2026', bodyAr:'وسّعت Number 1 نطاق خدماتها الجغرافي ليشمل دول الخليج العربي بشكل رسمي.', bodyEn:'Number 1 officially expanded its geographic reach to include Gulf countries.' },
